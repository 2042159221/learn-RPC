...
public class KryoSerializerTest {
    ...
    /**
     * 测试 KryoSerializer 实例化
     */
    @Test
    public void testKryoSerializerInstance() {
        // 直接使用KryoSerializer，不通过SPI加载
    ...
    /**
     * 测试 SerializerFactory 是否能正确获取 KryoSerializer
     */
    @Test
    public void testSerializerFactory() {
        ...
        // 通过SerializerFactory获取KryoSerializer
        Serializer serializer = SerializerFactory.getInstance(SerializerKeys.KRYO);
        Assert.assertNotNull(serializer);
        Assert.assertTrue(serializer instanceof KryoSerializer);
    }
} 